...
async function transcribe(audio) {
    ...
    await pipeline(audio, {
        ...
        callback_function: generationTracker.chunkCallback.bind(generationTracker),
...
class GenerationTracker {
    ...
    chunkCallback(data) {
        this.processed_chunks.push(data)
    ...
    processChunk(chunk, index) {
        ...
        return {
            ...
            end: Math.round || Math.round(start + 0.9 * this.stride_length_s)
        }
    }
}
